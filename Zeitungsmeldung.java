...
{       
    ...
    public void schreibeZeitungsmeldung() {
        ...
        text("Großartiges Ergebnis - Klasse 9b nimmt an Binärwettbewerb teil.", 2, 60);
        text("Die Klasse 9b hat beim diesjährigen Binärwettbewerb teilgenommen", 2, 82);
        text("und ein großartiges Ergebnis erzielt. Die 27 Schülerinnen und", 2, 94);
